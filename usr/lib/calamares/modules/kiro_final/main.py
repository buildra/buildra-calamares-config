...
def run():
    ...
    libcalamares.utils.debug("Start buildra_final module")
    libcalamares.utils.debug("#################################\n")
    ...
    # --- Remove buildra-calamares-config package ---
    libcalamares.utils.debug("##############################################")
    libcalamares.utils.debug("Removing buildra-calamares-config package")
    libcalamares.utils.debug("##############################################\n")
    
    try:
        subprocess.run(
            ["chroot", target_root, "pacman", "-R", "--noconfirm", "buildra-calamares-config"],
            check=True
        )
    except subprocess.CalledProcessError as e:
        libcalamares.utils.warning(f"Failed to remove buildra-calamares-config: {e}")

    libcalamares.utils.debug("##############################################")
    libcalamares.utils.debug("End buildra_final module")
    libcalamares.utils.debug("##############################################\n")
